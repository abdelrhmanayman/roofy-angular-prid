...
@Component({
  selector: 'app-additional-picture',
  templateUrl: './additional-picture.component.html',
  styleUrls: ['./additional-picture.component.scss']
})
export class AdditionalPictureComponent implements OnInit {
